...
if(!isset($_SESSION['uid'])){
  ...
  $sql= "SELECT * FROM user WHERE email = '$email'";
    ...
    if(isset($_POST['edit'])){
      ...
      $sql1 = "UPDATE user SET username='$username', email='$emails', walletbalance='$walletbalance', refbonus='$refbonus', refcode='$refcode', profit='$profit', pname='$pname', phone='$phone', country='$country', address='$address' WHERE email='$email'";
