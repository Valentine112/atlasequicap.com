...
<input type="password"  name="opassword"   placeholder="Old Password" class="form-control form-inp">
 
</div>          
<div class="form-group">
<input type="password"  name="password"   placeholder="New Password" class="form-control form-inp">
