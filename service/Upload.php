            ...
            if($create_folder['status'] === 1):
                ...
                for($i = 0; $i < $fileCount; $i++):
                    ...
                    elseif($size > 10000000):
                        $this->status = 0;
                        $this->message = "fill";
                        $this->content = "File size shouldn't be greater than 10 megebytes";
                        ...
                        //print_r(move_uploaded_file($tmp_name, $folderPath));
                        if(move_uploaded_file($tmp_name, $folderPath)):
                            ...
                            $this->status = 0;
                            $this->message = "void";
                            $this->content = "Failed to upload image";
                            break;
                        endif;
