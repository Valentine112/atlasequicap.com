                    ...
                    <section class="crypto-box">
                        <div class="row justify-content-start">
                            ...
                            <div class="col-3 text-left">
                                <span id="price" class="sub-sub-text text-success">12.00</span>
                            </div>
                        </div>
                        <div class="row mt-3 justify-content-around mx-auto">
                            ...
                            <div class="col-12 col-lg-4 justify-content-around card-box">
                                <div class="data-header mx-auto">
                                    <div id="nav-tab" role="tablist" class="justify-content-around mx-auto">
                                ...
                                <div class="cryptoOrder" style="font-size: 15px!important;">
                                    ...
                                    <div class="mt-3 row">
                                        ...
                                        <div class="col-10 text-end">
                                            ...
                                            <button class="btn btn-danger" style="opacity: 0.2">Sell</button>
                                        </div>
                                    </div>
                                    <hr>
...
<script>
    function fetchCoins() {
        ...
        .then(data => {
            ...
            selectedOption = coin.options[ind]
            coin.prepend(selectedOption)
        })
