...
<head>
    ...
    <title>ITradeMarket Corporation</title>
    <style>
        body{
...
<body>
    <main>
        ...
        <section class="dashboard content traders profile">
            <header class="col-11 col-md-8 mx-auto mb-2">
                <h5>Top Traders</h5>
                <span>Hint* Always choose a trader with good ROI</span>
            </header>
            <div class="row boxCover justify-content-around col-12">
                <div class="col-12 col-lg-8 row justify-content-around align-content-start mb-3 text-center detail-box">
                    <div class="col-4">
                        <small>Copytrading</small>
                        <h5><?= $cTrader > 0 ? $cData['name'] : "None"; ?></h5>
                    </div>
                    <div class="col-4">
                        <small>Ending</small>
                        <h5><?= $cTrader > 0 ? (5 - $cCount) : "None"; ?></h5>
                    </div>
                    <div class="col-4">
                        <small>Invested</small>
                        <h5><?= $cTrader > 0 ? "$".$cAmount : "None"; ?></h5>
                    </div>
                    <?php if($cTrader > 0): ?>
                        <div class="col-9">
                ...
                <?php foreach ($traders[0] as $key => $trader): ?>
                    <div class="col-12 col-md-5 traders-box" data-parent="body">
                        <div class="col-12 row justify-content-between align-items-center">
                            <div class="col-8 row align-items-center">
                                ...
                                <div class="col-5">
                                    ...
                                    <br>
                                    <small><i class="las la-users"></i>&ensp;<?= $trader['followers']; ?></small>
                                </div>
                            </div>
                            <div class="col-4 text-right">
                                <button class="copy" onclick="copyTrade(this)"><i class="las la-copy"></i>Copy</button>
                            </div>
                        </div>
                        <div class="col-12 row justify-content-around align-items-center">
                            ...
                            <div class="col-4">
                                <small class="faint">Followers PnL</small>
                                <h5><?= $trader['pnl'] < 0 ? "-" : "+"; ?><?= $trader['pnl']; ?></h5>
                            </div>
                        </div>
