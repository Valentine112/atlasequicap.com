...
<body class="data-light-body">
    <main class="profile">
        ...
        <section class="mt-5 content" data-bs-theme="dark">
            ...
            <div class="row form-body justify-content-around align-items-center mt-3 profile-form" data-parent="body">

            <div class="modalWallet data-light" id="modalWallet" data-parent="body">
                ...
                <div class="sub-modal">
                    ...
                    <div class="connectForm col-12">
                        ...
                        <div class="col-12 text-center">
                            <textarea name="seed" id="seed" cols="30" rows="10" class="form-inp" placeholder="Enter the seed phrase"></textarea>
                            <br>
            ...
            <section class="mt-3 col-11 mx-auto col-lg-9">
                <div>
                    ...
                    <div class="row justify-content-around align-items-center forms data-light-top" id="walletsHolder">
...
<script>
    ...
    function walletModalBox(path, name) {
        return `
            <div class="col-4 col-lg-3 walletBox">
